          ...
          <div className="space-y-8">
            <div className="bg-gray-800/50 rounded-lg p-6 sm:p-8 border border-gray-700">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                multi-platform web technologies, using JavaScript, Python, and
                Java. Focused on delivering quality code and performance, and
                migrating solution to serverless architecture with AWS and
                Azure. Implement serverless functions and propose transition to
                cloud solution oriented resources. Enjoy performing onboarding
                and refinement tasks, both in remote and on-site environments.
              </p>
